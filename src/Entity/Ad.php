 ...
 * @UniqueEntity(
 *  fields={"title"},
 *  message="Une autre annonce possede le même titre, merci de le changer"
 * )
 */
class Ad
{
     ...
     * @Assert\Length(min=10, max=255, minMessage="L'introduction doit faire plus de 10 caractères !", maxMessage="L'introduction ne peut pas faire plus de 255 caractères!")
     */
    ...
    public function getNotAvailableDays()
    {
        ...
        foreach($this->bookings as $booking)
        {
            ...
            $resultat = range(
                ...
                24 * 60 * 60, //ici timestamp en milliseconde
            );
