...
{
    /**
     * Permet d'avoir la configuration de base
     *
     * @param [string] $label
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('content',
            TextareaType::class,
            $this->getConfiguration("Description déaillée", "Tapez une description détaillée de votre logement")
            )
            ->add('rooms',
            IntegerType::class,
            ...
            //ici colection d'image a uploader
            ->add('images',
            CollectionType::class,
            [
                'entry_type' => ImageType::class,
                'allow_add' => true, //on peut rajouter des elements
                'allow_delete' => true //permet de supprimer
            ]
            )
            ;
        ;
